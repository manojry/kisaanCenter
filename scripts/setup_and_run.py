...
Purpose: Automates creation of superadmin, owner, and shop via API calls for initial system setup.
Usage: python setup_and_run.py
Dependencies: requests, API server running at http://127.0.0.1:8000
"""
import requests
import json
