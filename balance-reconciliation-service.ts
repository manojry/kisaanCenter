...
import { Transaction } from './kisaan-backend-node/src/models/transaction';
import { Payment } from './kisaan-backend-node/src/models/payment';
import { TransactionLedger } from './kisaan-backend-node/src/models/transactionLedger';
import BalanceSnapshot from './kisaan-backend-node/src/models/balanceSnapshot';
import { PaymentAllocation } from './kisaan-backend-node/src/models/paymentAllocation';
import { AuditLog } from './kisaan-backend-node/src/models/auditLog';
...
export class BalanceReconciliationService {
  ...
  async reconcilePaymentAllocations(paymentId: number): Promise<{
    ...
    const allocatedAmount = allocations.reduce((sum, alloc) => 
