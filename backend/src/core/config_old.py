...
class APISettings(BaseSettings):
    ...
    max_upload_size: int = Field(10 * 1024 * 1024)  # 10MB
...
class BusinessSettings(BaseSettings):
    ...
    default_commission_rate: float = Field(0.05, description="Default commission rate")
    max_credit_limit: float = Field(100000.0, description="Maximum credit limit")
    transaction_timeout_hours: int = Field(24, description="Transaction timeout in hours")
