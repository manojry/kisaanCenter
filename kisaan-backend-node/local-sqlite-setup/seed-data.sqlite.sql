...
-- Insert a sample superadmin user (password is a placeholder)
INSERT OR IGNORE INTO kisaan_users (username, password, role, status, balance, cumulative_value) VALUES ('superadmin', 'changeme', 'superadmin', 'active', 0.00, 0.00);

-- Insert a sample shop and owner
INSERT OR IGNORE INTO kisaan_users (username, password, role, status, balance, cumulative_value) VALUES ('dmr_owner', 'changeme', 'owner', 'active', 0.00, 0.00);
