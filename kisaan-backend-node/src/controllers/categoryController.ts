...
export class CategoryController {
  ...
  return failureCode(res, 500, ErrorCodes.CREATE_CATEGORY_FAILED, undefined, error.message || 'Failed to create category');
  }
};
  ...
  return failureCode(res, 500, ErrorCodes.GET_CATEGORIES_FAILED, undefined, error.message || 'Failed to retrieve categories');
  }
};
  ...
  return failureCode(res, 500, ErrorCodes.GET_CATEGORY_FAILED, undefined, error.message || 'Failed to retrieve category');
  }
};
  ...
  return failureCode(res, 500, ErrorCodes.UPDATE_CATEGORY_FAILED, undefined, error.message || 'Failed to update category');
  }
};
  ...
  return failureCode(res, 500, ErrorCodes.DELETE_CATEGORY_FAILED, undefined, error.message || 'Failed to delete category');
  }
};
  ...
  return failureCode(res, 500, ErrorCodes.SEARCH_CATEGORIES_FAILED, undefined, error.message || 'Failed to search categories');
  }
};
